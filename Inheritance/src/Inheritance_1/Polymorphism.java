...
public class Polymorphism {
    public static void main(String[] args) {
        ...
        // 대입연사자의 왼쪽의 타입은 상속관계에 의해 부모 클래스일 수 있음
...
//        D d3 = new C(); // C는 D이다(X)
        ...
        B bc = new C(); // C->B 업캐스팅
        B bb = new B();
        A a = (A)bb; // B->A 업캐스팅. 업캐스팅의 다른방법

        // 다운캐스팅
        // 가능한 경우와 불가능한 경우가 있음
        // 생성지에 의해 원래 타입이 결정되므로 부모로 업캐스팅된 후 다시 원래 타입으로 돌아오는 다운캐스팅은 가능함!
...
//        C c = (C)aa; // 다운캐스팅 불가
        ...
        A ad = new D(); // 원래타입은 D인데 A로 업캐스팅
        B bd = (B)ad; // A->B 다운캐스팅 가능. D는 B이기 때문
