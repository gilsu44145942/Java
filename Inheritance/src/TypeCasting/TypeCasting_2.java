...
public class TypeCasting_2 {
    public static void main(String[] args) {
        ...
        // instanceof 키워든 뒤에 적는 클래스의 특징(=속성)을 가지고 있는지 물어보는 것
        ...
        // instanceof와 getClass.getName 의 차이점
        // instanceof 상속관계를 포함하고 있음
        // getClass.getName 은 상속관계를 무시하고 정확히 동일한 클레스만을 리턴
