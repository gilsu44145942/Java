...
/* 데이터베이스에는 무결점으 데이터가 필수 (= 무결성의 원칙)
테이블의 아무런 제약사항을 주지 않으면 적합하지 않은 데이터가 저장되고
그렇게되면 무결서의 원칙의 위배됨!
...
dafault : 값을 안 넣으면 자동으로 기본값을 저장
foreign key : 외래키, FK
auto_increment : 숫자형 값의 자동증가
*/

/* primary key 와 unique의 차이점
PK : 테이블의 각 행을 고유하게 식별하는 컬럼. 케이블당 오직 한개만 가능.
자동으로 unique와 not null속성을 가짐. 인덱스를 자동으로 생성

unique : 테이블에서 고유한 값 조방. 자동으로 null속성 가짐.
인덱스를 자동 생성하지 않음, 테이블내에서 여러개의 unique 컬럼을 가질 수 있음. 
*/
create table 학과
...
values ('S0001','Steve','2000-01-01','010-1111-2222','남');

insert into 학생 (학번, 이름 , 생일, 연락처, 성별)
values ('S0002','Tom','2000-01-01','010-2222-3333','남');
...
장르 varchar (20)check(장르 in ('코미디','드라마','SF','액션','기타')),
...
values ('Grrr','MV001', 5, 'good');

insert into 평점 (평가자닉네임, 영화번호, 평점, 평가)
values ('Grrr','MV002', 5, 'good'); -- 에러발생. MV002라는 영화번호가 영화테이블에 없음
