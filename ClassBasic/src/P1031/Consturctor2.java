...
public class Consturctor2 {
    ...
    public static void main(String[] args) {
        ...
        // <원인>생성자내에 필드 매개변수의 이름이 같으면, 필드 this 키워드를 명시적으로 사용해야 함
        // 명시적인 표시가 없으면 자압는 지역변수 a로 판단함
...
class AA{
    int a;
    int b;
    // 생성자의 오버로딩(생성자의 이름은 같고, 매개변수의 갯수가 다름)
    ...
    AA(int a,int b){
        a=a;
        b=b;
        System.out.println("매개변수 2개 int");
    }
}