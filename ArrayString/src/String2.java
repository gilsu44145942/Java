...
public class String2 {
    public static void main(String[] args) {
        ...
        // #2. 문자열 검색 charAt()-입력한 숫자 번째의 문자를 찾는 방식., indexOf()-앞에서 부터 찾는 방식.
        // , lastIndexOf()-끝에서 부터 찾는 방식.
        ...
        System.out.println(str1.indexOf("java")); //-1 (못찾았을 경우, 대소문자 구별자)
        System.out.println();

        // #3. 문자열의 변화 및 연결 valueOf(), concat()
        ...
        // byte array는  UTF-8 문자를 담는데 이용됨. 한글을 촤소 2바이트가 필요.
